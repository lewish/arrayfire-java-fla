...
public record Convolver2D<D0 extends Number, D1 extends Number, D2 extends Number, FD3 extends Number>(
    ...
    public Shape<N, N, FD3, U> outputShape() {
        ...
        return af.shape(af.n((input.d0().intValue() - filters.d0().intValue()) / stride.d0().intValue() + 1),
                af.n((input.d1().intValue() - filters.d1().intValue()) / stride.d1().intValue() + 1), filters.d3());
    }
}
